    ...
    @if ($loaded)
        <div class="col-span-3 md:col-span-1">
            <div class="bg-gray-50 dark:text-gray-400 dark:bg-gray-800 dark:hover:bg-gray-700 dark:hover:text-white rounded-lg overflow-hidden">
                <a href="{{ route('events') }}" class="w-full inline-flex items-center justify-center p-5 text-base font-medium text-gray-500 bg-gray-50 hover:text-gray-900 dark:text-gray-400 dark:bg-gray-800 dark:hover:bg-gray-700 dark:hover:text-white">
