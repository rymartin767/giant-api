<div wire:init="initLoading">
    @if ($loaded)
        <div class="col-span-3 md:col-span-1">
            <div class="rounded-lg bg-gray-50 hover:text-gray-900 hover:bg-gray-100 dark:text-gray-400 dark:bg-gray-800 dark:hover:bg-gray-700 dark:hover:text-white">
                ...
                <div class="px-3 pb-3 text-sm italic text-slate-300">{{ $status }}</div>
            </div>
        </div>
    @else
        <div class="col-span-3 md:col-span-1 bg-gray-50">
            <div>LOADING</div>
        </div>
    @endif
</div>