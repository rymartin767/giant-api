...
it('returns an error response for empty icao parameter', function() {
...
it('returns an error response for bad parameter', function() {
    Pilot::factory()->create();
...
it('returns an error response for model not found', function() {
    Pilot::factory()->create();
...
it('returns a model response', function() {
